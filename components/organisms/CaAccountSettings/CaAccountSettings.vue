<template>
  <div class="ca-account-settings">
    <div class="ca-account-settings__inner">
        ...
        .mutate({
          ...
          variables: {
            ...
            user: {
              ...
              personalId: '' // TODO: remove when charlie has removed it's obligatoriskt
            }
          },
          context() {
            return {
