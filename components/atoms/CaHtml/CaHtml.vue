...
<script>
// Source: https://github.com/TYPO3-Initiatives/nuxt-typo3/blob/master/lib/templates/components/utilities/HtmlParser.vue

// @group Atoms
// @vuese
// Parsing HTML adding listeners to links so that internal links gets routed to. Also adds a basic style to user added HTML if needed<br><br>
